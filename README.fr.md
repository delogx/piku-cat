...
## Pourquoi les équipes choisissent piku-cat
...
- **Apprend de votre contexte** : Piku s'adapte à votre architecture, vos standards et votre workflow.
...
<br />
Connectez vos propres identifiants de fournisseur et choisissez les modèles derrière les revues piku-cat : OpenAI, Anthropic, Google Gemini, Vertex AI, Novita, ou tout endpoint compatible OpenAI. Gardez la facturation et l'utilisation sous votre propre compte fournisseurs, sans majoration LLM cachée.

<br />
<br />

<p align="center">
  <img src="https://kodus.io/wp-content/uploads/2026/06/byok-scaled.png" alt="Configuration du fournisseur de modèle piku-cat BYOK" width="900">
</p>
...
<p align="center">
  <img src="https://kodus.io/wp-content/uploads/2026/06/token-usage-scaled.png" alt="Dashboard d'utilisation des tokens piku-cat" width="900">
</p>
...
<br />
Piku Rules permet aux équipes de définir des instructions de revue en langage naturel et de les appliquer au niveau des organisations, dépôts, chemins ou portées de revue spécifiques. Piku utilise ces règles comme contexte lors de la revue des pull requests, aidant à faire respecter les décisions d'architecture, les attentes de sécurité, les pratiques de test et les conventions spécifiques au dépôt sans dépendre des relecteurs pour répéter manuellement le même feedback.

<br />
<br />

<p align="center">
  <img src="https://kodus.io/wp-content/uploads/2026/06/rules-scaled.png" alt="Règles Piku" width="900">
</p>
</details>
<br />
<details>
...
<br />
Cockpit aide les équipes à mesurer l'efficacité des revues piku-cat, la santé des Piku Rules, la santé des dépôts et les métriques de livraison à travers le workflow d'ingénierie.

<br />
<br />

<p align="center">
  <img src="https://kodus.io/wp-content/uploads/2026/06/cockpit-kodus-scaled.png" alt="Cockpit piku-cat montrant la santé du pipeline de revue de code IA" width="900">
</p>
...
<br />
Suivez automatiquement les suggestions non implémentées issues des pull requests fermées, gérez-les par statut, sévérité, catégorie et dépôt, et laissez Piku les résoudre lorsque le correctif apparaît dans une future PR.
<br />
<br />

<p align="center">
  <img src="https://kodus.io/wp-content/uploads/2026/06/issues-scaled.png" alt="Dashboard Piku Issues" width="900">
</p>
...
<br />
<details>
  <summary><strong>🔎 Voir Piku reviewer une vraie pull request</strong></summary>
<br />
Piku fait bien plus que résumer les diffs. Il examine le code avec contexte, signale les risques par sévérité, et suggère des correctifs concrets directement dans la pull request.
...
<p align="center">
  <img
    ...
    alt="Piku détectant un problème de sécurité IDOR critique dans une revue de pull request"
    width="700"
  />
</p>

Dans cet exemple, Piku intercepte un risque IDOR critique où un paramètre de requête `organizationId` pourrait contourner la protection tenant lorsqu'il est passé sous forme de tableau, puis suggère une validation explicite à l'exécution avant que le code ne soit mergé.

</details>

## Pour commencer

Choisissez le workflow qui correspond à la façon dont vous souhaitez utiliser piku-cat.
...
<table>
  <tr>
    ...
    <td width="50%">
      <strong>Auto-héberger piku-cat</strong>
      <br />
      Déployez piku-cat sur votre propre infrastructure avec le contrôle des données, des modèles,
  ...
  <tr>
    ...
    <td width="50%">
      ...
      <br />
      Exécutez le monorepo piku-cat localement pour le développement sur l'API, le worker,
...
| Chemin | Objectif |
| --- | --- |
| `apps/api` | API NestJS principale pour l'authentification, les organisations, les équipes, les Piku Rules, les intégrations, les permissions et l'orchestration des revues de code. |
| `apps/web` | Application web Next.js pour le dashboard piku-cat. |
...
| Hébergement | Auto-hébergé **ou** hébergé par piku-cat | Hébergé par piku-cat | Auto-hébergé **ou** hébergé par piku-cat |
| Apportez Votre Propre Clé (BYOK) | ✅ | ✅ | ✅ |
| Utilisation de PR | PR illimitées avec votre propre clé API | PR illimitées avec votre propre clé API | PR illimitées avec la clé API piku-cat AI Tokens |
...
| --- | --- |
| [Site web](https://kodus.io) | En savoir plus sur piku-cat, les capacités produit et les tarifs. |
| [Documentation](https://docs.kodus.io) | Guides d'installation, docs produit, utilisation CLI et instructions d'auto-hébergement. |
| [Kodus Cloud](https://app.kodus.io) | Commencez à utiliser piku-cat sans gérer d'infrastructure. |
| [Guide d'auto-hébergement](https://docs.kodus.io/how_to_deploy/en/deploy_kodus/generic_vm) | Déployez piku-cat dans votre propre environnement. |
...
| [Communauté Discord](https://discord.gg/6WbWrRbsH7) | Posez des questions, obtenez de l'aide à l'installation et échangez avec l'équipe piku-cat. |
| [Tarifs](https://kodus.io/pricing) | Comparez les éditions Community, Teams et Enterprise. |
| [Planifier un appel](https://cal.com/gabrielmalinosqui/30min) | Discutez avec l'équipe piku-cat de l'installation, de l'auto-hébergement ou des besoins enterprise. |
...
<p align="left">
  <img src="https://kodus.io/wp-content/uploads/2026/06/kody-contributing-scaled.png" alt="Piku contribuant" width="230" />
</p>
