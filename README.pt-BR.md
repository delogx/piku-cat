...
## Por Que as Equipes Escolhem o piku-cat
...
- **Aprende com Seu Contexto**: Piku se adapta à sua arquitetura, padrões e fluxo de trabalho.
...
<br />
Conecte suas próprias credenciais de provedor e escolha os modelos por trás das revisões do piku-cat: OpenAI, Anthropic, Google Gemini, Vertex AI, Novita ou qualquer endpoint compatível com OpenAI. Mantenha o faturamento e o uso na sua própria conta do provedor, sem markups ocultos de LLM.

<br />
<br />

<p align="center">
  <img src="https://kodus.io/wp-content/uploads/2026/06/byok-scaled.png" alt="Configuração de provedor de modelo BYOK do piku-cat" width="900">
</p>
...
<p align="center">
  <img src="https://kodus.io/wp-content/uploads/2026/06/token-usage-scaled.png" alt="Dashboard de uso de tokens do piku-cat" width="900">
</p>
...
<br />
Piku Rules permitem que as equipes definam instruções de revisão em linguagem natural e as apliquem em organizações, repositórios, paths ou escopos específicos de revisão. Piku usa essas regras como contexto ao revisar pull requests, ajudando a garantir decisões de arquitetura, expectativas de segurança, práticas de teste e convenções específicas de repositório sem depender de revisores para repetir o mesmo feedback manualmente.

<br />
<br />

<p align="center">
  <img src="https://kodus.io/wp-content/uploads/2026/06/rules-scaled.png" alt="Regras do Piku" width="900">
</p>
</details>
<br />
<details>
...
<br />
Cockpit ajuda as equipes a medir a eficácia das revisões do piku-cat, a saúde das Piku Rules, a saúde dos repositórios e as métricas de entrega em todo o fluxo de trabalho de engenharia.

<br />
<br />

<p align="center">
  <img src="https://kodus.io/wp-content/uploads/2026/06/cockpit-kodus-scaled.png" alt="Cockpit do piku-cat mostrando a saúde do pipeline de revisão de código com IA" width="900">
</p>
...
<br />
Acompanhe automaticamente sugestões não implementadas de PRs fechados, gerencie-as por status, severidade, categoria e repositório, e deixe Piku resolvê-las quando a correção aparecer em um PR futuro.
<br />
<br />

<p align="center">
  <img src="https://kodus.io/wp-content/uploads/2026/06/issues-scaled.png" alt="Dashboard do piku-cat Issues" width="900">
</p>
...
<br />
<details>
  <summary><strong>🔎 Veja o Piku revisando um pull request real</strong></summary>
<br />
Piku faz mais do que resumir diffs. Ele revisa código com contexto, sinaliza riscos por severidade e sugere correções concretas diretamente no pull request.
...
<p align="center">
  <img
    ...
    alt="Piku detectando um problema crítico de segurança IDOR em uma revisão de pull request"
    width="700"
  />
</p>

Neste exemplo, Piku captura um risco crítico de IDOR onde um parâmetro de consulta `organizationId` poderia contornar a proteção de tenant quando passado como um array, e então sugere uma validação explícita em runtime antes que o código seja merged.

</details>

## Comece Agora

Escolha o fluxo de trabalho que corresponde a como você quer usar o piku-cat.
...
<table>
  <tr>
    ...
    <td width="50%">
      <strong>Faça self-host do piku-cat</strong>
      <br />
      Faça deploy do piku-cat na sua própria infraestrutura com controle sobre dados, modelos
  ...
  <tr>
    ...
    <td width="50%">
      ...
      <br />
      Rode o monorepo do piku-cat localmente para desenvolvimento na API, worker,
...
piku-cat é um monorepo com múltiplas aplicações, bibliotecas de domínio compartilhadas e pacotes publicados.
...
| Path | Finalidade |
| --- | --- |
| `apps/api` | API NestJS principal para autenticação, organizações, equipes, Piku Rules, integrações, permissões e orquestração de revisão de código. |
| `apps/web` | Aplicação web Next.js para o dashboard do piku-cat. |
...
| `libs` | Módulos de domínio NestJS compartilhados usados nas aplicações do piku-cat. |
...
| Hosting | Self-hosted **ou** hospedado pelo piku-cat | Hospedado pelo piku-cat | Self-hosted **ou** hospedado pelo piku-cat |
| Traga Sua Própria Chave (BYOK) | ✅ | ✅ | ✅ |
| Uso de PR | PRs ilimitados usando sua própria API key | PRs ilimitados usando sua própria API key | PRs ilimitados usando a API key de Tokens do piku-cat AI |
| Usuários | Ilimitados | Ilimitados | Ilimitados |
| Piku Rules | Até 10 | Ilimitadas | Ilimitadas |
| Plugins ativos | Até 3 | Ilimitados | Ilimitados |
| Piku Learnings e Memória | ✅ | ✅ | ✅ |
| Issues do Quality Radar | Ilimitadas | Ilimitadas | Ilimitadas |
| Fila prioritária para Piku Agents | ❌ | ✅ | ✅ |
...
| Recurso | Descrição |
| --- | --- |
| [Website](https://kodus.io) | Saiba mais sobre o piku-cat, capacidades do produto e preços. |
| [Documentação](https://docs.kodus.io) | Guias de configuração, docs de produto, uso da CLI e instruções de self-host. |
| [Kodus Cloud](https://app.kodus.io) | Comece a usar o piku-cat sem gerenciar infraestrutura. |
| [Guia de Self-Host](https://docs.kodus.io/how_to_deploy/en/deploy_kodus/generic_vm) | Faça deploy do piku-cat no seu próprio ambiente. |
...
| [Comunidade no Discord](https://discord.gg/6WbWrRbsH7) | Faça perguntas, obtenha ajuda de configuração e converse com a equipe do piku-cat. |
| [Preços](https://kodus.io/pricing) | Compare as edições Community, Teams e Enterprise. |
| [Agende uma Chamada](https://cal.com/gabrielmalinosqui/30min) | Converse com a equipe do piku-cat sobre configuração, self-host ou necessidades enterprise. |
...
<p align="left">
  <img src="https://kodus.io/wp-content/uploads/2026/06/kody-contributing-scaled.png" alt="Piku contribuindo" width="230" />
</p>
