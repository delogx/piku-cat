...
If you're planning to integrate piku-cat with cloud-based Git providers (GitHub, GitLab, or Bitbucket), you'll need public-facing URLs for both the piku-cat Web App and its API. This allows your server to receive webhooks for proper Code Review functionality and ensures correct application behavior.
...
<Steps>
  ...
  <Step title="Success 🎉">
  When complete, piku-cat Services should be running on your machine.
...
3. **Select repositories** for analysis - Choose which code repositories Piku will review
