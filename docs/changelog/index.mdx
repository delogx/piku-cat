---
title: "Changelog"
description: "Latest piku-cat updates and improvements."
rss: true
---
...
<div className="kodus-changelog-shell">
    <div className="kodus-changelog-filter-sidebar">
        <div className="kodus-changelog-filter-panel" aria-label="Changelog filters">
            ...
            <div className="kodus-changelog-filter-options">
                ...
                <label className="kodus-changelog-filter-button">
                    <input className="kodus-changelog-filter-control" type="checkbox" id="kodus-filter-cli" />
                    <span>CLI</span>
                </label>
            </div>
        </div>
    ...
    <div className="kodus-changelog-release">
        <div className="kodus-changelog-meta">
            <span className="kodus-changelog-date">August 10, 2026</span>
        </div>
        ...
        <div className="kodus-changelog-content">
            <div className="kodus-changelog-section">
                ...
                <div className="kodus-changelog-item kodus-changelog-filterable filter-ai-engine">
                    <div role="heading" aria-level="3" className="kodus-changelog-title">Linked Repository Context in Reviews</div>
                    <p className="kodus-changelog-copy">Piku can now reference linked repositories while reviewing a pull request. This gives it better context for changes that depend on contracts, shared libraries, internal APIs, or standards maintained outside the current repository.</p>
                    <p className="kodus-changelog-copy">In practice, suggestions can now more accurately account for how the code connects to the rest of your organization’s ecosystem.</p>
                </div>

                <div className="kodus-changelog-item kodus-changelog-filterable filter-cli filter-ux-interface">
                    <div role="heading" aria-level="3" className="kodus-changelog-title">Findings Sidebar and a New CLI Review Experience</div>
                    <p className="kodus-changelog-copy">The Kodus CLI now offers a more complete review experience. In addition to inline comments, you can now view a sidebar with findings grouped by severity and jump directly between them.</p>
                    <p className="kodus-changelog-copy">The update also improves navigation through large diffs and expands support for reviewing branches, commits, and specific files from the same interface.</p>
                    <video autoPlay loop muted playsInline preload="auto" className="kodus-changelog-video">
                        <source src="https://kodus.io/wp-content/uploads/2026/08/kodus-cli.mp4" type="video/mp4" />
                    </video>
                </div>
            </div>
            ...
            <div className="kodus-changelog-section">
                ...
                <div className="kodus-changelog-item kodus-changelog-filterable filter-ai-engine filter-kody-rules">
                    <div role="heading" aria-level="3" className="kodus-changelog-title">Fewer Duplicate Comments in Reviews</div>
                    <p className="kodus-changelog-copy">Deduplication now considers suggestions generated by both Piku and Piku Rules together, with an additional semantic layer. In practice, when both flows identify the same issue, the PR is more likely to receive a single useful comment instead of repeated feedback.</p>
                </div>
            </div>
            ...
            <div className="kodus-changelog-section">
                ...
                <div className="kodus-changelog-fix-list">
                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-kody-rules">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Fragmented <code className="kodus-changelog-code">@file</code> references in Piku Rules:</strong> we fixed how <code className="kodus-changelog-code">@file</code> references are loaded during fragmented reviews. External files are now properly considered even when a rule is processed in multiple parts.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-ai-engine filter-ux-interface">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Slow reviews no longer appear as “no review”:</strong> we improved how long-running reviews and LLM rate-limiting scenarios are handled. PR status now more accurately reflects a review that is still running or temporarily constrained, rather than suggesting that no review took place.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-git-provider filter-performance">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Recovery after hitting GitHub rate limits:</strong> when the integration hits a GitHub API rate limit, the job now fails fast and is requeued instead of silently getting stuck. This makes review execution and recovery more predictable.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-byok filter-ux-interface">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">BYOK status now accurately reflects your configuration:</strong> the subscription screen now correctly detects whether an organization has a valid BYOK key connected, including locally managed configurations. This prevents conflicting messages about the key’s status.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-ai-engine filter-performance">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Large tool outputs no longer break agent execution:</strong> we improved compression for large JSON responses returned by agent tools. The data structure is preserved, and execution remains stable even with large outputs.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-performance">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">More stable event processing:</strong> we fixed a pool exhaustion and event amplification scenario that could affect asynchronous processing. The pipeline now uses resources more safely under load.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-ai-engine filter-byok">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Deduplication remains stable with BYOK:</strong> the embeddings used to prevent duplicate suggestions are now pinned to the correct provider, even when an organization uses BYOK or a custom endpoint.</p>
                    </div>
                </div>
            </div>
    ...
    <div className="kodus-changelog-release">
        <div className="kodus-changelog-meta">
            <span className="kodus-changelog-date">July 30, 2026</span>
        </div>
        ...
        <div className="kodus-changelog-content">
            <div className="kodus-changelog-section">
                ...
                <div className="kodus-changelog-item kodus-changelog-filterable filter-kody-rules filter-ux-interface filter-billing-licenses">
                    <div role="heading" aria-level="3" className="kodus-changelog-title">Global Rules Sync from Repositories</div>
                    <p className="kodus-changelog-copy">Organizations on the Teams plan can now configure repositories as sources for Global Rules. This allows teams to keep their review rules version-controlled directly in Git, alongside the project's technical context, while Piku automatically syncs those rules for use during reviews.</p>
                    <p className="kodus-changelog-copy">This release also introduces a new interface under Code Review settings where users can select, save, and manage source repositories, monitor import status, and manually trigger a new sync when needed.</p>
                    <p className="kodus-changelog-copy">In practice, this makes it easier to adopt shared standards across teams and repositories. Instead of manually creating rules in each configuration, organizations can centralize conventions, best practices, and internal policies in dedicated repositories, with greater visibility and control over when those rules were last synced.</p>
                    <video autoPlay loop muted playsInline preload="auto" className="kodus-changelog-video">
                        <source src="/videos/global-rules-for-repository.mp4" type="video/mp4" />
                    </video>
                </div>

                <div className="kodus-changelog-item kodus-changelog-filterable filter-kody-rules filter-ai-engine filter-performance">
                    <div role="heading" aria-level="3" className="kodus-changelog-title">Piku Rules with Structured Summaries</div>
                    <p className="kodus-changelog-copy">We now run a preliminary analysis on every Piku Rule to better understand its intent before it is used in a review.</p>
                    <p className="kodus-changelog-copy">When a rule is too broad or covers multiple behaviors, it can be broken down into atomic rules: smaller, more specific rules that can either be validated deterministically with regex or evaluated by an LLM when contextual interpretation is required.</p>
                    <p className="kodus-changelog-copy">In practice, this helps Piku apply complex rules more accurately. Instead of treating a long rule as a single block, the agent works with smaller validation units, reducing ambiguity while better preserving the rule's original intent.</p>
                </div>
            </div>
            ...
            <div className="kodus-changelog-section">
                ...
                <div className="kodus-changelog-item kodus-changelog-filterable filter-kody-rules filter-ai-engine">
                    <div role="heading" aria-level="3" className="kodus-changelog-title">Better PR Scope for Piku Rules</div>
                    <p className="kodus-changelog-copy">The agent now uses the full PR diff when applying Piku Rules instead of relying only on file names. This gives Piku more meaningful context about the actual changes being reviewed.</p>
                    <p className="kodus-changelog-copy">With this improvement, rules that depend on modified content have a stronger basis for evaluation. This is especially relevant for rules that verify implementation patterns, contract changes, internal API usage, or sensitive changes in specific parts of the code.</p>
                </div>

                <div className="kodus-changelog-item kodus-changelog-filterable filter-kody-rules filter-performance">
                    <div role="heading" aria-level="3" className="kodus-changelog-title">Reviews Now Skip Global Rules Source Repositories</div>
                    <p className="kodus-changelog-copy">When a repository is used exclusively as a source for Global Rules, Piku now skips reviews in that repository. This prevents repositories created solely to store rules from generating unnecessary reviews.</p>
                    <p className="kodus-changelog-copy">In addition to reducing noise for the team, this also avoids consuming resources on a workflow that provides no practical value. The source repository can now serve its purpose as a configuration source without being treated like a regular product repository.</p>
                </div>

                <div className="kodus-changelog-item kodus-changelog-filterable filter-ai-engine filter-performance">
                    <div role="heading" aria-level="3" className="kodus-changelog-title">Better Token and Context Management in the Agent Loop</div>
                    <p className="kodus-changelog-copy">The agent's token and context management has been strengthened with stricter per-request limits, a real tokenizer, and more accurate overhead accounting. This makes the agent's behavior more predictable on large PRs or when a significant amount of context has accumulated.</p>
                    <p className="kodus-changelog-copy">In practice, this reduces the risk of context overflow and makes executions more stable. The agent can operate within more reliable limits, improving both review quality and the rate of intermittent failures.</p>
                </div>

                <div className="kodus-changelog-item kodus-changelog-filterable filter-byok filter-ai-engine filter-ux-interface">
                    <div role="heading" aria-level="3" className="kodus-changelog-title">Clearer LLM and BYOK Error Messages</div>
                    <p className="kodus-changelog-copy">We improved the messages displayed when failures occur involving LLMs or BYOK keys. Instead of returning generic errors, the system now makes it clearer whether the issue is related to configuration, quota, billing, or communication with the provider.</p>
                    <p className="kodus-changelog-copy">This makes troubleshooting easier for administrators and technical users. In BYOK environments, where the provider key and account are managed by the customer, clearer messages reduce investigation time and help teams resolve issues without relying on trial and error.</p>
                </div>

                <div className="kodus-changelog-item kodus-changelog-filterable filter-ai-engine filter-performance">
                    <div role="heading" aria-level="3" className="kodus-changelog-title">Langfuse Telemetry Compatible with AI SDK 7</div>
                    <p className="kodus-changelog-copy">Langfuse telemetry has been updated to work correctly with AI SDK 7, including improved handling of cache, reasoning, and token usage fields.</p>
                    <p className="kodus-changelog-copy">This improvement increases the accuracy of observability data for AI calls. With more reliable metrics, it becomes easier to monitor costs, model behavior, and the impact of changes to the review pipeline.</p>
                </div>

                <div className="kodus-changelog-item kodus-changelog-filterable filter-git-provider filter-ux-interface filter-performance">
                    <div role="heading" aria-level="3" className="kodus-changelog-title">Improved Pagination for Bitbucket and Repository Lists</div>
                    <p className="kodus-changelog-copy">Pagination has been improved across Bitbucket flows and repository lists in the frontend. This makes the experience more robust for organizations with a large number of repositories or paginated responses from the integration.</p>
                    <p className="kodus-changelog-copy">With this improvement, the system can handle larger volumes of data more reliably, preventing incomplete lists and reducing failures during onboarding or integration setup.</p>
                </div>

                <div className="kodus-changelog-item kodus-changelog-filterable filter-kody-rules filter-security">
                    <div role="heading" aria-level="3" className="kodus-changelog-title">Safer Centralized Config</div>
                    <p className="kodus-changelog-copy">Centralized Config sync now avoids deleting configurations when discovery fails or returns an empty result. Previously, a failure during the discovery process could create a risk of incorrect reconciliation.</p>
                    <p className="kodus-changelog-copy">With this safeguard, the system now handles partial failures more conservatively. This reduces the risk of accidentally losing rules or configurations and improves the reliability of a sensitive workflow for organizations that depend on centralized configuration.</p>
                </div>
            </div>
            ...
            <div className="kodus-changelog-section">
                ...
                <div className="kodus-changelog-fix-list">
                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-git-provider filter-ai-engine">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Fixed GitLab Suggestions:</strong> we fixed suggestion creation in GitLab so comments are only added to newly added lines, preventing phantom suggestions.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-git-provider">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Support for Draft/WIP Merge Requests in GitLab:</strong> we now correctly respect Merge Requests marked as draft or work in progress in GitLab.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-git-provider filter-ux-interface">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Custom Bot Usernames in GitLab:</strong> we fixed support for review commands when the GitLab bot uses a custom username.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-git-provider filter-performance">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Fixed <code className="kodus-changelog-code">getCommits</code> Timeouts:</strong> transient <code className="kodus-changelog-code">getCommits</code> failures, such as Undici timeouts, are now handled correctly and rethrown when necessary.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-ai-engine filter-ux-interface">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Fixed the Needs Attention State:</strong> we fixed an issue that could leave a review stuck in the needs attention state.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-git-provider filter-ux-interface">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Fixed Onboarding and Member Telemetry:</strong> the onboarding flow received fixes to prevent it from getting stuck during member lookups and telemetry processing, especially in scenarios involving suspended users or slow API responses.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-ux-interface">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Fixed the Invitation Flow:</strong> the invitation page and flow were updated to prevent failures when new users join.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-git-provider">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Fixed GitHub Webhook Creation:</strong> webhook creation and listing now correctly use the repository owner, preventing failures when the repository owner differs from the primary account.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-ux-interface filter-kody-rules">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Fixed Repository-Level Configuration:</strong> we fixed the function used to delete repository-specific configurations.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-kody-rules filter-ux-interface">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Fixed Rule Creation and Import:</strong> the logic for adding global or repository-level rules was fixed, along with improvements to the search field.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-byok filter-ux-interface">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Fixed the BYOK Switching Button:</strong> the model and provider switching experience in BYOK was updated to prevent confusion during editing.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-ux-interface">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Fixed Language Flash in Settings:</strong> we fixed the visual language flash that appeared on settings pages after a reload.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-ux-interface">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Fixed Progress Bar Text:</strong> we updated the text displayed in the progress bar to improve interface clarity.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-performance">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Fixed API Errors for Invalid Parameters:</strong> Postgres <code className="kodus-changelog-code">22P02</code> errors, such as invalid UUIDs or integers, now return a 400 error instead of a 500.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-self-hosted filter-performance">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Sandbox Lease Fixes:</strong> we fixed race conditions and <code className="kodus-changelog-code">leaseCount</code> leaks in sandbox management, including cleanup, invalidation, and superseded lease scenarios.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-self-hosted filter-performance">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">RabbitMQ and Workflow Queue Fixes:</strong> workflow queues now use centralized arguments and are correctly declared and bound with a DLX, reducing inconsistencies during initialization.</p>
                    </div>
                </div>
            </div>
    ...
    <div className="kodus-changelog-release">
        <div className="kodus-changelog-meta">
            <span className="kodus-changelog-date">July 20, 2026</span>
        </div>
        ...
        <div className="kodus-changelog-content">
            <div className="kodus-changelog-section">
                ...
                <div className="kodus-changelog-item kodus-changelog-filterable filter-kody-rules filter-ux-interface">
                    <div role="heading" aria-level="3" className="kodus-changelog-title">Piku Rules: Select Reviewers</div>
                    <p className="kodus-changelog-copy">Piku Rules can now take selected reviewers into account during the configuration flow. This gives teams greater control when directing specific rules to the people or groups best suited to the context of a review.</p>
                    <p className="kodus-changelog-copy">This update helps reduce noise and improves rule governance, especially in organizations with multiple teams, domain areas, or repositories with clearly distributed ownership.</p>
                </div>
            </div>
            ...
            <div className="kodus-changelog-section">
                ...
                <div className="kodus-changelog-item kodus-changelog-filterable filter-ux-interface filter-kody-rules">
                    <div role="heading" aria-level="3" className="kodus-changelog-title">Removed Preset Step, Added Severity Level, and Fixed Enable/Disable Buttons</div>
                    <p className="kodus-changelog-copy">We simplified the review setup by removing the preset step and adding severity-level configuration. Teams can now define the level of criticality that reviews should consider directly during onboarding.</p>
                    <p className="kodus-changelog-copy">We also fixed the enabled and disabled states of several buttons, making the setup flow more predictable and reducing confusion during initial configuration.</p>
                </div>

                <div className="kodus-changelog-item kodus-changelog-filterable filter-ai-engine filter-ux-interface">
                    <div role="heading" aria-level="3" className="kodus-changelog-title">Append Team-Authored Custom Messages to Error Comments</div>
                    <p className="kodus-changelog-copy">Custom messages written by the team are now also included in code review error comments.</p>
                    <p className="kodus-changelog-copy">This allows Piku's communication to preserve the tone, context, and instructions defined by each organization, even when an analysis identifies an issue. The improvement helps standardize the developer experience and makes comments better aligned with each team's internal processes.</p>
                </div>

                <div className="kodus-changelog-item kodus-changelog-filterable filter-self-hosted filter-performance">
                    <div role="heading" aria-level="3" className="kodus-changelog-title">Bounded Reaper Concurrency and Improved Handling for E2B Sandboxes That No Longer Exist</div>
                    <p className="kodus-changelog-copy">We improved the process responsible for cleaning up sandboxes by introducing controlled concurrency. This prevents spikes in simultaneous operations and makes cleanup more stable in high-volume environments.</p>
                    <p className="kodus-changelog-copy">We also now correctly handle cases where a sandbox no longer exists in E2B, preventing unnecessary errors and making the sandbox lifecycle more resilient.</p>
                </div>

                <div className="kodus-changelog-item kodus-changelog-filterable filter-performance filter-cockpit filter-ux-interface">
                    <div role="heading" aria-level="3" className="kodus-changelog-title">Performance Improvements for Heavy Screens and Analytics</div>
                    <p className="kodus-changelog-copy">We refactored some of the product's heavier screens, particularly areas containing lists, filters, and analytics, to improve performance and responsiveness.</p>
                    <p className="kodus-changelog-copy">The work includes improvements to queries, rendering, data loading, and the overall visual experience in workflows that handle large amounts of information. The expected result is smoother navigation, less frontend overhead, and more reliable presentation of the displayed data.</p>
                </div>
            </div>
            ...
            <div className="kodus-changelog-section">
                ...
                <div className="kodus-changelog-fix-list">
                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-kody-rules filter-ai-engine">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Rules Generated from Past Reviews:</strong> fixed the generation of Piku Rules from previous reviews, improving the reliability of the rule-learning and creation flow.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-self-hosted">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Use the Correct Queue Names for the RabbitMQ Health Check:</strong> fixed the queue names used by the RabbitMQ health check. Previously, the check could fail to accurately reflect the state of the queues used by the application. It now checks the expected queue names, improving the accuracy of the system's health signals.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-security filter-self-hosted">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Harden Local Sandbox <code className="kodus-changelog-code">readFile</code>/<code className="kodus-changelog-code">writeFile</code> Path Validation:</strong> strengthened path validation for <code className="kodus-changelog-code">readFile</code> and <code className="kodus-changelog-code">writeFile</code> operations in the local sandbox. The change prevents unauthorized access outside the permitted directory and reinforces execution-environment isolation. This improves the security and reliability of file read and write operations within the sandbox.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-git-provider">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Fix Bitbucket Requests to Avoid 429 Errors:</strong> adjusted how requests are made to Bitbucket to reduce the occurrence of 429 rate-limit errors. The fix improves integration stability, especially for organizations with a high volume of repositories, pull requests, or simultaneous operations.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-security filter-self-hosted">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Close Parent Directory Swap TOCTOU Vulnerability in Local Sandbox <code className="kodus-changelog-code">writeFile</code>:</strong> fixed a time-of-check to time-of-use race condition in the local sandbox's <code className="kodus-changelog-code">writeFile</code> operation. The flow now performs stronger validation of the actual path before writing, preventing changes to the parent directory from redirecting the operation outside the expected location. This strengthens isolation and reduces risks during write operations.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-ux-interface">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Change <code className="kodus-changelog-code">@Piku resume</code> to <code className="kodus-changelog-code">@Piku start-review</code> in the Cadence Message:</strong> updated the cadence message to correctly instruct users to use <code className="kodus-changelog-code">@Piku start-review</code> instead of <code className="kodus-changelog-code">@Piku resume</code>. This reduces ambiguity and prevents incorrect commands from being suggested during the review flow.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-git-provider filter-self-hosted">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Resolve CLI Sandbox Clone Platform from the Connected Integration:</strong> fixed how the platform used to clone repositories inside the CLI sandbox is resolved. The platform is now determined based on the integration connected to the repository, preventing inconsistencies in environments using GitLab, Bitbucket, or other self-managed integrations.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-ai-engine">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Fix LLM Compression Message:</strong> fixed the compression message generated by the LLM during the code review flow. This step is used when the context needs to be compressed so the analysis can continue. The fix makes the communication clearer and prevents incorrect or confusing messages during processing.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-git-provider filter-ux-interface">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Remove Repository from Integration Configuration When Removed from Repository Settings:</strong> fixed synchronization between repository-level settings and integration settings. When a repository is removed from the repository-level configuration, it is now also correctly removed from the integration configuration, preventing inconsistent states and unexpected review behavior.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-ai-engine filter-kody-rules">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Business Rules Validation:</strong> fixed the business rules validation flow. This change improves the reliability of business-rule-based analysis, helping Piku interpret and apply these validations more consistently during code review.</p>
                    </div>
                </div>
            </div>
        ...
        <div className="kodus-changelog-content">
            <div className="kodus-changelog-section">
                ...
                <div className="kodus-changelog-item kodus-changelog-filterable filter-kody-rules filter-ai-engine filter-performance">
                    ...
                    <p className="kodus-changelog-copy">Organizations that created Piku Rules before this release can also benefit from the new architecture. We created an automated process that analyzes existing rules and, whenever possible, generates mechanical detectors for them.</p>
            ...
            <div className="kodus-changelog-section">
                ...
                <div className="kodus-changelog-item kodus-changelog-filterable filter-kody-rules filter-ai-engine filter-performance">
                    <div role="heading" aria-level="3" className="kodus-changelog-title">More Accurate and Predictable Piku Rules</div>
                    <p className="kodus-changelog-copy">We restructured how Piku applies custom rules during code reviews. Instead of relying solely on a more open-ended agent analysis, rules are now evaluated deterministically by file and PR scope.</p>
                    <p className="kodus-changelog-copy">In practice, this improves rule coverage in large PRs, reduces cases where an applicable rule is overlooked, and makes Piku Rules behave more consistently across different models.</p>
                    <p className="kodus-changelog-copy">We also introduced mechanical detectors for certain rules. When a rule can safely be converted into an objective check, Piku can apply it without making an LLM call, reducing costs and improving predictability.</p>
                </div>
                ...
                <div className="kodus-changelog-item kodus-changelog-filterable filter-ai-engine filter-ux-interface">
                    ...
                    <p className="kodus-changelog-copy">We adjusted the format of Piku's review comments to prevent internal reasoning structures from appearing in the output and to make suggestions more natural, concise, and easier to understand.</p>
                ...
                <div className="kodus-changelog-item kodus-changelog-filterable filter-byok filter-ai-engine">
                    ...
                    <p className="kodus-changelog-copy">We improved the observability of LLM calls to ensure token usage is attributed correctly, especially within the new Piku Rules and agent workflows.</p>
                ...
                <div className="kodus-changelog-item kodus-changelog-filterable filter-ai-engine filter-kody-rules">
                    ...
                    <p className="kodus-changelog-copy">We added new end-to-end scenarios and evaluations to validate Piku Rules, model recall, suggestion adherence, and prompt regressions.</p>
                ...
                <div className="kodus-changelog-item kodus-changelog-filterable filter-ux-interface filter-byok filter-ai-engine">
                    ...
                    <p className="kodus-changelog-copy">We updated the documentation for BYOK, custom messages, and focused reviews. We also revised the README and added new pages explaining how to guide Piku during a review.</p>
                </div>
            </div>
            ...
            <div className="kodus-changelog-section">
                ...
                <div className="kodus-changelog-fix-list">
                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-security filter-kody-rules">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Safer Rule Execution:</strong> we added protections against potentially unsafe regex patterns in Piku Rules detectors. This prevents malformed or computationally expensive rules from affecting review performance. We also fixed cases where outdated detectors could remain associated with a rule after an edit changed the rule's intended behavior.</p>
                    </div>
        ...
        <div className="kodus-changelog-content">
            <div className="kodus-changelog-section">
                ...
                <div className="kodus-changelog-item kodus-changelog-filterable filter-ai-engine">
                    ...
                    <p className="kodus-changelog-copy">You can now ask Piku to pay special attention to something specific during a review, without changing any configuration.</p>
                    ...
                    <p className="kodus-changelog-copy">Focus works as a priority, not a filter. Piku pays closer attention to the context you provide, but still reports other concrete issues it finds in the diff.</p>
            ...
            <div className="kodus-changelog-section">
                ...
                <div className="kodus-changelog-fix-list">
                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-ux-interface filter-git-provider">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Review comments with broken formatting:</strong> fixed cases where Piku comments appeared with unexpected formatting in pull requests.</p>
                    </div>
                    ...
                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-ai-engine filter-git-provider">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">@kody conversation crashing on JSON wrapped in prose:</strong> fixed a crash that happened when Piku responded to mentions and the output came back as text containing embedded JSON.</p>
                    </div>
                    ...
                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-kody-rules">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Rules with multiple directories:</strong> adjusted Piku Rules validation to correctly handle rules that apply to multiple path groups.</p>
                    </div>

                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-kody-rules">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Automatic code review config creation:</strong> when a repository did not have a code review configuration, creating a Piku Rule could fail silently. The configuration is now created automatically.</p>
                    </div>
        ...
        <div className="kodus-changelog-content">
            <div className="kodus-changelog-section">
                ...
                <div className="kodus-changelog-item kodus-changelog-filterable filter-ai-engine">
                    ...
                    <p className="kodus-changelog-copy">We updated Piku's review pipeline to improve analysis accuracy and reduce cases where important issues could slip through unnoticed.</p>
                ...
                <div className="kodus-changelog-item kodus-changelog-filterable filter-kody-rules">
                    <div role="heading" aria-level="3" className="kodus-changelog-title">Unified Piku Rules lifecycle</div>
                    <p className="kodus-changelog-copy">We unified the Piku Rules flow into a single lifecycle, regardless of where the rule was created: the library, manual creation, or inheritance from the organization to the repository.</p>
                    ...
                    <p className="kodus-changelog-copy">This makes the system more consistent, reduces unexpected states, and ensures that an active rule is actually applied in Piku reviews.</p>
                </div>
                ...
                <div className="kodus-changelog-item kodus-changelog-filterable filter-mcp">
                    ...
                    <p className="kodus-changelog-copy">We removed the dependency on Composio as an external MCP broker and moved to our own implementation for GitHub Issues, now integrated with piku-cat Issues.</p>
            ...
            <div className="kodus-changelog-section">
                ...
                <div className="kodus-changelog-item kodus-changelog-filterable filter-kody-rules">
                    <div role="heading" aria-level="3" className="kodus-changelog-title">Piku Rules Origin</div>
                    <p className="kodus-changelog-copy">We added an explicit origin to all Piku Rules: <code className="kodus-changelog-code">LIBRARY</code>, <code className="kodus-changelog-code">MANUAL</code>, <code className="kodus-changelog-code">INHERITED</code>, and <code className="kodus-changelog-code">SUGGESTED</code>.</p>
        ...
        <div className="kodus-changelog-content">
            <div className="kodus-changelog-section">
                ...
                <div className="kodus-changelog-item kodus-changelog-filterable filter-git-provider">
                    ...
                    <p className="kodus-changelog-copy">Review comments, commit statuses, force-push detection, and webhook coverage now work consistently for Forgejo repositories. If you self-host with Forgejo, Piku behaves just like on any other major platform.</p>
                </div>
            </div>
            ...
            <div className="kodus-changelog-section">
                ...
                <div className="kodus-changelog-item kodus-changelog-filterable filter-performance">
                    ...
                    <p className="kodus-changelog-copy">Eliminated duplicate API calls when syncing Piku Rules from changed files. PRs with many files now close noticeably faster.</p>
                </div>
            ...
            <div className="kodus-changelog-section">
                ...
                <div className="kodus-changelog-fix-list">
                    ...
                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-ai-engine">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Piku conversation replies with empty responses:</strong> resolved an issue where Piku occasionally replied with blank content in PR comment threads when using Claude Sonnet.</p>
                    </div>
    ...
    <div className="kodus-changelog-release">
        ...
        <div className="kodus-changelog-content">
            <div className="kodus-changelog-section">
                ...
                <div className="kodus-changelog-item kodus-changelog-filterable filter-ai-engine">
                    <div role="heading" aria-level="3" className="kodus-changelog-title">Redesigned piku-cat Review tab</div>
            ...
            <div className="kodus-changelog-section">
                ...
                <div className="kodus-changelog-fix-list">
                    ...
                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-kody-rules">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Centralized config sync:</strong> we fixed issues in the centralized sync of Piku Rules configurations across repositories. Sync now correctly handles multiple scopes, stale configurations, and merge-triggered updates.</p>
                    </div>
                </div>
            </div>
    ...
    <div className="kodus-changelog-release">
        ...
        <div className="kodus-changelog-content">
            ...
            <div className="kodus-changelog-section">
                ...
                <div className="kodus-changelog-item kodus-changelog-filterable filter-ai-engine">
                    <div role="heading" aria-level="3" className="kodus-changelog-title">Faster Piku Rules</div>
            ...
            <div className="kodus-changelog-section">
                ...
                <div className="kodus-changelog-fix-list">
                    ...
                    <div className="kodus-changelog-fix kodus-changelog-filterable filter-ai-engine">
                        <p className="kodus-changelog-copy"><strong className="kodus-changelog-fix-label">Integration reset:</strong> Piku Rules linked to the repo/directory are now removed automatically.</p>
                    </div>
...
<div className="kodus-changelog-rss-source" aria-hidden="true">
    <Update label="August 10, 2026 - Linked Repository Context in Reviews" tags={["AI Engine"]}>
        Piku can now reference linked repositories while reviewing a pull request. This gives it better context for changes that depend on contracts, shared libraries, internal APIs, or standards maintained outside the current repository.

        In practice, suggestions can now more accurately account for how the code connects to the rest of your organization’s ecosystem.
    </Update>

    <Update label="August 10, 2026 - Findings Sidebar and a New CLI Review Experience" tags={["CLI", "UX & Interface"]}>
        The Kodus CLI now offers a more complete review experience. In addition to inline comments, you can now view a sidebar with findings grouped by severity and jump directly between them.

        The update also improves navigation through large diffs and expands support for reviewing branches, commits, and specific files from the same interface.

        Video: https://kodus.io/wp-content/uploads/2026/08/kodus-cli.mp4
    </Update>

    <Update label="August 10, 2026 - Fewer Duplicate Comments in Reviews" tags={["AI Engine", "Piku Rules"]}>
        Deduplication now considers suggestions generated by both Piku and Piku Rules together, with an additional semantic layer. In practice, when both flows identify the same issue, the PR is more likely to receive a single useful comment instead of repeated feedback.
    </Update>

    <Update label="August 10, 2026 - Fragmented @file References in Piku Rules" tags={["Piku Rules"]}>
        We fixed how @file references are loaded during fragmented reviews. External files are now properly considered even when a rule is processed in multiple parts.
    </Update>

    <Update label="August 10, 2026 - Slow Reviews No Longer Appear as No Review" tags={["AI Engine", "UX & Interface"]}>
        We improved how long-running reviews and LLM rate-limiting scenarios are handled. PR status now more accurately reflects a review that is still running or temporarily constrained, rather than suggesting that no review took place.
    </Update>

    <Update label="August 10, 2026 - Recovery After Hitting GitHub Rate Limits" tags={["GIT Provider", "Performance"]}>
        When the integration hits a GitHub API rate limit, the job now fails fast and is requeued instead of silently getting stuck. This makes review execution and recovery more predictable.
    </Update>

    <Update label="August 10, 2026 - BYOK Status Now Accurately Reflects Your Configuration" tags={["BYOK", "UX & Interface"]}>
        The subscription screen now correctly detects whether an organization has a valid BYOK key connected, including locally managed configurations. This prevents conflicting messages about the key’s status.
    </Update>

    <Update label="August 10, 2026 - Large Tool Outputs No Longer Break Agent Execution" tags={["AI Engine", "Performance"]}>
        We improved compression for large JSON responses returned by agent tools. The data structure is preserved, and execution remains stable even with large outputs.
    </Update>

    <Update label="August 10, 2026 - More Stable Event Processing" tags={["Performance"]}>
        We fixed a pool exhaustion and event amplification scenario that could affect asynchronous processing. The pipeline now uses resources more safely under load.
    </Update>

    <Update label="August 10, 2026 - Deduplication Remains Stable with BYOK" tags={["AI Engine", "BYOK"]}>
        The embeddings used to prevent duplicate suggestions are now pinned to the correct provider, even when an organization uses BYOK or a custom endpoint.
    </Update>

    <Update label="July 30, 2026 - Global Rules Sync from Repositories" tags={["Piku Rules", "UX & Interface", "Billing & Licenses"]}>
        Organizations on the Teams plan can now configure repositories as sources for Global Rules. This allows teams to keep their review rules version-controlled directly in Git, alongside the project's technical context, while Piku automatically syncs those rules for use during reviews.

        This release also introduces a new interface under Code Review settings where users can select, save, and manage source repositories, monitor import status, and manually trigger a new sync when needed.

        In practice, this makes it easier to adopt shared standards across teams and repositories. Instead of manually creating rules in each configuration, organizations can centralize conventions, best practices, and internal policies in dedicated repositories, with greater visibility and control over when those rules were last synced.

        Video: /videos/global-rules-for-repository.mp4
    </Update>

    <Update label="July 30, 2026 - Piku Rules with Structured Summaries" tags={["Piku Rules", "AI Engine", "Performance"]}>
        We now run a preliminary analysis on every Piku Rule to better understand its intent before it is used in a review.

        When a rule is too broad or covers multiple behaviors, it can be broken down into atomic rules: smaller, more specific rules that can either be validated deterministically with regex or evaluated by an LLM when contextual interpretation is required.

        In practice, this helps Piku apply complex rules more accurately. Instead of treating a long rule as a single block, the agent works with smaller validation units, reducing ambiguity while better preserving the rule's original intent.
    </Update>

    <Update label="July 30, 2026 - Better PR Scope for Piku Rules" tags={["Piku Rules", "AI Engine"]}>
        The agent now uses the full PR diff when applying Piku Rules instead of relying only on file names. This gives Piku more meaningful context about the actual changes being reviewed.

        With this improvement, rules that depend on modified content have a stronger basis for evaluation. This is especially relevant for rules that verify implementation patterns, contract changes, internal API usage, or sensitive changes in specific parts of the code.
    </Update>

    <Update label="July 30, 2026 - Reviews Now Skip Global Rules Source Repositories" tags={["Piku Rules", "Performance"]}>
        When a repository is used exclusively as a source for Global Rules, Piku now skips reviews in that repository. This prevents repositories created solely to store rules from generating unnecessary reviews.

        In addition to reducing noise for the team, this also avoids consuming resources on a workflow that provides no practical value. The source repository can now serve its purpose as a configuration source without being treated like a regular product repository.
    </Update>

    <Update label="July 30, 2026 - Better Token and Context Management in the Agent Loop" tags={["AI Engine", "Performance"]}>
        The agent's token and context management has been strengthened with stricter per-request limits, a real tokenizer, and more accurate overhead accounting. This makes the agent's behavior more predictable on large PRs or when a significant amount of context has accumulated.

        In practice, this reduces the risk of context overflow and makes executions more stable. The agent can operate within more reliable limits, improving both review quality and the rate of intermittent failures.
    </Update>

    <Update label="July 30, 2026 - Clearer LLM and BYOK Error Messages" tags={["BYOK", "AI Engine", "UX & Interface"]}>
        We improved the messages displayed when failures occur involving LLMs or BYOK keys. Instead of returning generic errors, the system now makes it clearer whether the issue is related to configuration, quota, billing, or communication with the provider.

        This makes troubleshooting easier for administrators and technical users. In BYOK environments, where the provider key and account are managed by the customer, clearer messages reduce investigation time and help teams resolve issues without relying on trial and error.
    </Update>

    <Update label="July 30, 2026 - Langfuse Telemetry Compatible with AI SDK 7" tags={["AI Engine", "Performance"]}>
        Langfuse telemetry has been updated to work correctly with AI SDK 7, including improved handling of cache, reasoning, and token usage fields.

        This improvement increases the accuracy of observability data for AI calls. With more reliable metrics, it becomes easier to monitor costs, model behavior, and the impact of changes to the review pipeline.
    </Update>

    <Update label="July 30, 2026 - Improved Pagination for Bitbucket and Repository Lists" tags={["GIT Provider", "UX & Interface", "Performance"]}>
        Pagination has been improved across Bitbucket flows and repository lists in the frontend. This makes the experience more robust for organizations with a large number of repositories or paginated responses from the integration.

        With this improvement, the system can handle larger volumes of data more reliably, preventing incomplete lists and reducing failures during onboarding or integration setup.
    </Update>

    <Update label="July 30, 2026 - Safer Centralized Config" tags={["Piku Rules", "Security"]}>
        Centralized Config sync now avoids deleting configurations when discovery fails or returns an empty result. Previously, a failure during the discovery process could create a risk of incorrect reconciliation.

        With this safeguard, the system now handles partial failures more conservatively. This reduces the risk of accidentally losing rules or configurations and improves the reliability of a sensitive workflow for organizations that depend on centralized configuration.
    </Update>

    <Update label="July 30, 2026 - Fixed GitLab Suggestions" tags={["GIT Provider", "AI Engine"]}>
        We fixed suggestion creation in GitLab so comments are only added to newly added lines, preventing phantom suggestions.
    </Update>

    <Update label="July 30, 2026 - Support for Draft/WIP Merge Requests in GitLab" tags={["GIT Provider"]}>
        We now correctly respect Merge Requests marked as draft or work in progress in GitLab.
    </Update>

    <Update label="July 30, 2026 - Custom Bot Usernames in GitLab" tags={["GIT Provider", "UX & Interface"]}>
        We fixed support for review commands when the GitLab bot uses a custom username.
    </Update>

    <Update label="July 30, 2026 - Fixed getCommits Timeouts" tags={["GIT Provider", "Performance"]}>
        Transient getCommits failures, such as Undici timeouts, are now handled correctly and rethrown when necessary.
    </Update>

    <Update label="July 30, 2026 - Fixed the Needs Attention State" tags={["AI Engine", "UX & Interface"]}>
        We fixed an issue that could leave a review stuck in the needs attention state.
    </Update>

    <Update label="July 30, 2026 - Fixed Onboarding and Member Telemetry" tags={["GIT Provider", "UX & Interface"]}>
        The onboarding flow received fixes to prevent it from getting stuck during member lookups and telemetry processing, especially in scenarios involving suspended users or slow API responses.
    </Update>

    <Update label="July 30, 2026 - Fixed the Invitation Flow" tags={["UX & Interface"]}>
        The invitation page and flow were updated to prevent failures when new users join.
    </Update>

    <Update label="July 30, 2026 - Fixed GitHub Webhook Creation" tags={["GIT Provider"]}>
        Webhook creation and listing now correctly use the repository owner, preventing failures when the repository owner differs from the primary account.
    </Update>

    <Update label="July 30, 2026 - Fixed Repository-Level Configuration" tags={["UX & Interface", "Piku Rules"]}>
        We fixed the function used to delete repository-specific configurations.
    </Update>

    <Update label="July 30, 2026 - Fixed Rule Creation and Import" tags={["Piku Rules", "UX & Interface"]}>
        The logic for adding global or repository-level rules was fixed, along with improvements to the search field.
    </Update>

    <Update label="July 30, 2026 - Fixed the BYOK Switching Button" tags={["BYOK", "UX & Interface"]}>
        The model and provider switching experience in BYOK was updated to prevent confusion during editing.
    </Update>

    <Update label="July 30, 2026 - Fixed Language Flash in Settings" tags={["UX & Interface"]}>
        We fixed the visual language flash that appeared on settings pages after a reload.
    </Update>

    <Update label="July 30, 2026 - Fixed Progress Bar Text" tags={["UX & Interface"]}>
        We updated the text displayed in the progress bar to improve interface clarity.
    </Update>

    <Update label="July 30, 2026 - Fixed API Errors for Invalid Parameters" tags={["Performance"]}>
        Postgres 22P02 errors, such as invalid UUIDs or integers, now return a 400 error instead of a 500.
    </Update>

    <Update label="July 30, 2026 - Sandbox Lease Fixes" tags={["Self-hosted", "Performance"]}>
        We fixed race conditions and leaseCount leaks in sandbox management, including cleanup, invalidation, and superseded lease scenarios.
    </Update>

    <Update label="July 30, 2026 - RabbitMQ and Workflow Queue Fixes" tags={["Self-hosted", "Performance"]}>
        Workflow queues now use centralized arguments and are correctly declared and bound with a DLX, reducing inconsistencies during initialization.
    </Update>
    ...
    <Update label="July 13, 2026 - Automatic Detector Backfill for Existing Rules" tags={["Piku Rules", "AI Engine", "Performance"]}>
        Organizations that created Piku Rules before this release can also benefit from the new architecture. We created an automated process that analyzes existing rules and, whenever possible, generates mechanical detectors for them.
    ...
    <Update label="July 13, 2026 - More Accurate and Predictable Piku Rules" tags={["Piku Rules", "AI Engine", "Performance"]}>
        We restructured how Piku applies custom rules during code reviews. Instead of relying solely on a more open-ended agent analysis, rules are now evaluated deterministically by file and PR scope.

        In practice, this improves rule coverage in large PRs, reduces cases where an applicable rule is overlooked, and makes Piku Rules behave more consistently across different models.

        We also introduced mechanical detectors for certain rules. When a rule can safely be converted into an objective check, Piku can apply it without making an LLM call, reducing costs and improving predictability.
    </Update>
    ...
    <Update label="July 13, 2026 - Cleaner Review Comments" tags={["AI Engine", "UX & Interface"]}>
        We adjusted the format of Piku's review comments to prevent internal reasoning structures from appearing in the output and to make suggestions more natural, concise, and easier to understand.
    ...
    <Update label="July 13, 2026 - More Accurate Cost Tracking and Telemetry" tags={["BYOK", "AI Engine"]}>
        We improved the observability of LLM calls to ensure token usage is attributed correctly, especially within the new Piku Rules and agent workflows.
    ...
    <Update label="July 13, 2026 - New Quality Tests and Validations" tags={["AI Engine", "Piku Rules"]}>
        We added new end-to-end scenarios and evaluations to validate Piku Rules, model recall, suggestion adherence, and prompt regressions.
    ...
    <Update label="July 13, 2026 - Updated Documentation" tags={["UX & Interface", "BYOK", "AI Engine"]}>
        We updated the documentation for BYOK, custom messages, and focused reviews. We also revised the README and added new pages explaining how to guide Piku during a review.
    </Update>

    <Update label="July 13, 2026 - Safer Rule Execution" tags={["Security", "Piku Rules"]}>
        We added protections against potentially unsafe regex patterns in Piku Rules detectors. This prevents malformed or computationally expensive rules from affecting review performance. We also fixed cases where outdated detectors could remain associated with a rule after an edit changed the rule's intended behavior.
    </Update>
    ...
    <Update label="July 6, 2026 - Steer a review with focus" tags={["AI Engine"]}>
        You can now ask Piku to pay special attention to something specific during a review, without changing any configuration.
        ...
        Focus works as a priority, not a filter. Piku pays closer attention to the context you provide, but still reports other concrete issues it finds in the diff.
    ...
    <Update label="July 6, 2026 - Review comments with broken formatting" tags={["UX & Interface", "GIT Provider"]}>
        Fixed cases where Piku comments appeared with unexpected formatting in pull requests.
    </Update>
    ...
    <Update label="July 6, 2026 - @kody conversation crashing on JSON wrapped in prose" tags={["AI Engine", "GIT Provider"]}>
        Fixed a crash that happened when Piku responded to mentions and the output came back as text containing embedded JSON.
    </Update>

    <Update label="July 6, 2026 - IDE sync config now respects approval settings" tags={["Piku Rules"]}>
        IDE rule synchronization now respects the approval configuration.
    </Update>

    <Update label="July 6, 2026 - Rules with multiple directories" tags={["Piku Rules"]}>
        Adjusted Piku Rules validation to correctly handle rules that apply to multiple path groups.
    </Update>

    <Update label="July 6, 2026 - Automatic code review config creation" tags={["Piku Rules"]}>
        When a repository did not have a code review configuration, creating a Piku Rule could fail silently. The configuration is now created automatically.
    </Update>
    ...
    <Update label="June 29, 2026 - Validated review engine" tags={["AI Engine"]}>
        We updated Piku's review pipeline to improve analysis accuracy and reduce cases where important issues could slip through unnoticed.
    ...
    <Update label="June 29, 2026 - Unified Piku Rules lifecycle" tags={["Piku Rules"]}>
        We unified the Piku Rules flow into a single lifecycle, regardless of where the rule was created: the library, manual creation, or inheritance from the organization to the repository.
        ...
        This makes the system more consistent, reduces unexpected states, and ensures that an active rule is actually applied in Piku reviews.
    </Update>

    <Update label="June 29, 2026 - Migrate away from Composio" tags={["MCP"]}>
        We removed the dependency on Composio as an external MCP broker and moved to our own implementation for GitHub Issues, now integrated with piku-cat Issues.
    ...
    <Update label="June 29, 2026 - Inheritance toggle" tags={["Piku Rules"]}>
    ...
    <Update label="June 29, 2026 - Piku Rules Origin" tags={["Piku Rules"]}>
        We added an explicit origin to all Piku Rules: LIBRARY, MANUAL, INHERITED, and SUGGESTED.
    ...
    <Update label="June 29, 2026 - Pending rules section" tags={["UX & Interface", "Piku Rules"]}>
    ...
    <Update label="June 22, 2026 - Forgejo support is now on par with GitHub & GitLab" tags={["GIT Provider"]}>
        Review comments, commit statuses, force-push detection, and webhook coverage now work consistently for Forgejo repositories. If you self-host with Forgejo, Piku behaves just like on any other major platform.
    </Update>

    <Update label="June 22, 2026 - Faster PR closing for large repos" tags={["Performance"]}>
        Eliminated duplicate API calls when syncing Piku Rules from changed files. PRs with many files now close noticeably faster.
    </Update>
    ...
    <Update label="June 22, 2026 - Piku conversation replies with empty responses" tags={["AI Engine"]}>
        Resolved an issue where Piku occasionally replied with blank content in PR comment threads when using Claude Sonnet.
    </Update>
    ...
    <Update label="June 15, 2026 - Redesigned piku-cat Review tab" tags={["AI Engine"]}>
    ...
    <Update label="June 15, 2026 - Centralized config sync" tags={["Piku Rules"]}>
        We fixed issues in the centralized sync of Piku Rules configurations across repositories. Sync now correctly handles multiple scopes, stale configurations, and merge-triggered updates.
    </Update>
    ...
    <Update label="June 8, 2026 - Faster Piku Rules" tags={["AI Engine"]}>
    ...
    <Update label="June 8, 2026 - Integration reset fix" tags={["AI Engine"]}>
        Piku Rules linked to the repo or directory are now removed automatically.
    </Update>
