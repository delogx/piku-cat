...
description: "Configure Piku Rules and Memories to enforce audit trail, data handling, and access control requirements."
icon: "file-shield"
---
...
Start by teaching Piku the high-level compliance principles:
