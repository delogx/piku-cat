...
description: "Learn how to use Fireworks AI's models with piku-cat"
icon: "fire"
---
...
4. Give your key a descriptive name (e.g., 'piku-cat' or any name you prefer)
...
<Tip>
  For detailed information about SSL setup, monitoring, and advanced configurations, see our [complete deployment guide](https://docs.kodus.io/how_to_deploy/en/deploy_kodus/generic_vm).
</Tip>
