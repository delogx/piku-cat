---
title: "piku-cat + sprint workflow"
...
Once connected, piku-cat can automatically fetch task context during reviews.
...
The quality of validation depends entirely on the quality of your task descriptions. piku-cat classifies task context as:
...
1. **Code quality review** — security, performance, style (standard piku-cat)
...
- If a PR intentionally doesn't cover all criteria (phased delivery), note it in the PR description so Piku can account for it
