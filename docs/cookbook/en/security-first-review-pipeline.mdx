...
description: "Set up Piku Rules focused on OWASP top 10, secrets detection, and secure coding patterns."
icon: "shield-halved"
---
...
This gives you piku-cat' built-in security checks. The rules below add your team's specific security policies on top.
...
1. Enable **Request Changes** in PR Workflow settings so Piku requests changes when critical issues are found
...
For more on configuring rules, see [Piku Rules](/how_to_use/en/code_review/configs/kody_rules).
