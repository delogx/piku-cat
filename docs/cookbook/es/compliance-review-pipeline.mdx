...
description: "Configura Piku Rules y Memorias para aplicar requisitos de registro de auditoría, manejo de datos y control de acceso."
icon: "file-shield"
---
...
Empieza enseñando a Piku los principios de cumplimiento de alto nivel:
