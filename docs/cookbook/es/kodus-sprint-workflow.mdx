---
title: "piku-cat + flujo de trabajo de sprint"
...
Una vez conectada, piku-cat puede obtener automáticamente el contexto de la tarea durante las revisiones.
...
La calidad de la validación depende completamente de la calidad de las descripciones de tus tareas. piku-cat clasifica el contexto de la tarea como:
...
1. **Revisión de calidad de código** — seguridad, rendimiento, estilo (piku-cat estándar)
...
- Si un PR intencionalmente no cubre todos los criterios (entrega por fases), anótalo en la descripción del PR para que Piku pueda tenerlo en cuenta
