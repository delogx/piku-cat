...
description: "Configura Piku Rules enfocadas en el OWASP top 10, detección de secretos y patrones de codificación segura."
icon: "shield-halved"
---
...
Esto te da las verificaciones de seguridad integradas de piku-cat. Las reglas a continuación añaden las políticas de seguridad específicas de tu equipo por encima.
...
1. Habilita **Solicitar cambios** en la configuración de flujo de trabajo de PR para que Piku solicite cambios cuando se encuentren problemas críticos
...
Para más información sobre la configuración de reglas, consulta [Piku Rules](/how_to_use/es/code_review/configs/kody_rules).
