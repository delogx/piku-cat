...
description: "Guía paso a paso para configurar piku-cat con un nuevo equipo, desde la conexión de repositorios hasta la enseñanza de las primeras convenciones."
icon: "users-gear"
---

## Descripción general

Poner en marcha un nuevo equipo con piku-cat lleva unos 30 minutos. Esta guía recorre la configuración completa para que tu equipo obtenga valor desde el primer PR.
...
1. Ve a **Configuración de Code Review** → **Piku Rules**
2. piku-cat detecta archivos `.cursorrules`, `.github/copilot-instructions.md` y `.claude`
...
Conecta Jira, Linear, Notion o ClickUp en **Configuración** → **Plugins** para habilitar la validación de lógica de negocio. Esto permite a piku-cat verificar si los PRs implementan lo que describen las tareas.

## Paso 7 — Ejecuta un PR piloto

Abre un PR de prueba y verifica:

- [ ] Los comentarios de piku-cat aparecen en el PR
...
- ¿Quieres reglas generadas automáticamente? → Haz clic en **Generar Piku Rules** para obtener sugerencias del historial de revisiones

## Consejos

- No sobrecargues con reglas el primer día — empieza pequeño y crece
- Deja que el equipo enseñe a Piku de forma natural mediante conversaciones antes de formalizarlo como reglas
- Usa `@kody start-review` durante los primeros PRs para que el equipo vea a piku-cat en acción
- Habilita la aprobación de memorias generadas por LLM si quieres revisar lo que aprende Piku
