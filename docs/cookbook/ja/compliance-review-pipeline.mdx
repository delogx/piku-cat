...
description: "監査トレイル、データ処理、アクセス制御要件を適用するためのPikuルールとMemoriesの設定方法。"
icon: "file-shield"
---
...
ルールの設定の詳細については、[Pikuルール](/how_to_use/ja/code_review/configs/kody_rules) を参照してください。
