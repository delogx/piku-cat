...
description: "Configure Piku Rules e Memories para aplicar trilha de auditoria, tratamento de dados e requisitos de controle de acesso."
icon: "file-shield"
---
...
Comece ensinando ao Piku os princípios gerais de conformidade:
