---
title: "piku-cat + fluxo de sprint"
...
Uma vez conectado, o piku-cat pode buscar automaticamente o contexto das tarefas durante as revisões.
...
A qualidade da validação depende inteiramente da qualidade das descrições das suas tarefas. O piku-cat classifica o contexto das tarefas como:
...
1. **Revisão de qualidade de código** — segurança, desempenho, estilo (piku-cat padrão)
...
- Se um PR intencionalmente não cobre todos os critérios (entrega faseada), anote isso na descrição do PR para que o Piku possa levar em conta
