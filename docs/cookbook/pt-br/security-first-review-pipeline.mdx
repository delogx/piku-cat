...
description: "Configure Piku Rules focadas no OWASP top 10, detecção de segredos e padrões de codificação segura."
icon: "shield-halved"
---
...
Isso fornece as verificações de segurança integradas do piku-cat. As regras abaixo adicionam as políticas de segurança específicas do seu time por cima.
...
1. Habilite **Solicitar Alterações** nas configurações de fluxo de trabalho de PR para que o Piku solicite mudanças quando problemas críticos forem encontrados
...
Para mais informações sobre configuração de regras, consulte [Piku Rules](/how_to_use/pt-br/code_review/configs/kody_rules).
