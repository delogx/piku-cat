...
验证质量完全取决于任务描述的质量。piku-cat 将任务上下文分类为：
...
1. **代码质量审查** — 安全性、性能、风格（标准 piku-cat）
...
- 如果 PR 有意不覆盖所有标准（分阶段交付），在 PR 描述中注明，以便 Piku 可以考虑
