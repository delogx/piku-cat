---
title: "安全优先的审查流程"
description: "设置专注于 OWASP Top 10、密钥检测和安全编码模式的 Piku 规则。"
icon: "shield-halved"
---
...
这提供 piku-cat 的内置安全检查。以下规则在此基础上添加团队的特定安全策略。
...
1. 在 PR 工作流设置中启用**请求更改**，使 Piku 在发现严重问题时请求更改
...
有关配置规则的更多信息，请参阅 [Piku 规则](/how_to_use/zh/code_review/configs/kody_rules)。
