---
title: "Installation"
description: "Deploy piku-cat on a Generic Virtual Machine."
icon: "plug"
---
...
MCP Manager is the service that connects Piku to external tools and exposes
...
These services are optional but significantly improve piku-cat's code review quality. Each requires you to create an account and generate an API key.

<AccordionGroup>
  <Accordion title="E2B — Code Execution Sandbox">
    E2B provides a secure sandbox that piku-cat uses to run and validate code during reviews.
  ...
  <Accordion title="MorphLLM — Code Editing Model">
    MorphLLM is a specialized model for fast, accurate code editing. piku-cat uses it to apply review suggestions more precisely.
