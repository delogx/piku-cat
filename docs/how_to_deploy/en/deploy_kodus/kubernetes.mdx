...
description: "Deploy piku-cat on Kubernetes or OpenShift with the official Helm charts."
icon: "dharmachakra"
---

Prefer a cluster over a single VM? piku-cat ships **Helm charts** for Kubernetes and
...
`imageTag` pins the piku-cat release for the whole stack (like Docker Compose
