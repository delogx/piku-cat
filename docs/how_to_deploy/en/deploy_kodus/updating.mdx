---
title: "Updating"
description: "Update your piku-cat installation."
icon: "arrow-up"
---
...
<Note>
  ...
  sent with `pnpm run telemetry:preview`, or set `KODUS_TELEMETRY_DISABLED=true`
  to opt out. Full schema and policy in
  [Anonymous Telemetry](/how_to_deploy/en/deploy_kodus/telemetry).
</Note>

To update your piku-cat installation to the latest version:

```bash
# Navigate to your piku-cat installation directory
cd kodus-installer
