...
description: "Get piku-cat running on your local machine — API, Worker, Webhooks, Web UI, and all dependencies in one command."
icon: "laptop"
---

<Note>
  This guide is for local development purposes. For production deployment,
  please refer to the [Deploy piku-cat](/how_to_deploy/en/deploy_kodus/generic_vm)
  guide.
</Note>
...
- ✅ **Services**: piku-cat API, Worker, Webhooks, Web, PostgreSQL, MongoDB, RabbitMQ
...
- Stop other services using these ports before starting piku-cat
