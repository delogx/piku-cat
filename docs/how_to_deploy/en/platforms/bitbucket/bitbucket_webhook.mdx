...
description: "Manually create the Bitbucket webhook when automatic registration didn't happen, and pick the pull request triggers piku-cat actually consumes."
icon: webhook
---
...
<Note>
  piku-cat only consumes Pull Request events — `created`, `updated`, `merged`, `declined`, and
