...
description: "Create the GitHub OAuth App that powers \"Sign in with GitHub\" for your piku-cat users — separate from the GitHub App used for code review."
icon: github
---

Use this if you want users to sign in to piku-cat with GitHub. This is separate from the GitHub App integration used for code review automation and webhooks.
...
After creating the app, copy the credentials from GitHub and add them to your piku-cat environment:
