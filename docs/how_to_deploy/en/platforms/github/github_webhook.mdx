...
description: "Manually create the GitHub webhook when automatic registration didn't happen, and select the three events piku-cat consumes."
icon: webhook
---
...
<Note>
  These are the only three events piku-cat consumes. Selecting extras (pushes, pull request
