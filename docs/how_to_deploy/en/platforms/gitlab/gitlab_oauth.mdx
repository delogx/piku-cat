...
description: "Create the GitLab OAuth App that powers \"Sign in with GitLab\" for your piku-cat users — separate from the webhook integration used for code review."
icon: gitlab
---

Use this if you want users to sign in to piku-cat with GitLab. This is separate from the GitLab webhook integration used for code review automation.
...
After creating the app, copy the credentials from GitLab and add them to your piku-cat environment:
