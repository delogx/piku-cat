...
description: "Despliega piku-cat en Kubernetes u OpenShift con los Helm charts oficiales."
icon: "dharmachakra"
---

¿Prefieres un clúster en lugar de una sola VM? piku-cat ofrece **Helm charts** para
...
`imageTag` fija la versión de piku-cat para todo el stack (como el `IMAGE_TAG` de
