...
description: "Cómo piku-cat parsea tu repo (kodus-graph), dónde se ejecuta (modos de sandbox), y cuándo elegir cada modo."
icon: "box"
---

Para revisar un PR con el contexto correcto, piku-cat parsea el repositorio
...
piku-cat usa [`@kodus/kodus-graph`](https://www.npmjs.com/package/@kodus/kodus-graph),
...
1. **Cuando seleccionas un repositorio** (en el setup, o al agregar un
   repo después en la UI) — piku-cat encola un job `AstGraphBuild` que
...
3. **En cada review de PR** — piku-cat carga el graph cacheado, parsea
...
puedes seguir usando piku-cat mientras terminan.
