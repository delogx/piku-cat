...
description: "Pone en marcha piku-cat en tu máquina local — API, Worker, Webhooks, interfaz web y todas las dependencias con un solo comando."
icon: "laptop"
---

<Note>
  Esta guía es para propósitos de desarrollo local. Para el despliegue en producción,
  consulta la guía [Desplegar piku-cat](/how_to_deploy/es/deploy_kodus/generic_vm).
</Note>
...
- ✅ **Servicios**: piku-cat API, Worker, Webhooks, Web, PostgreSQL, MongoDB, RabbitMQ
...
- Detén otros servicios que usen estos puertos antes de iniciar piku-cat
