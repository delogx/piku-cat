...
Usa esto si deseas que los usuarios inicien sesión en piku-cat con GitLab. Esto es independiente de la integración de webhooks de GitLab utilizada para la automatización de revisiones de código.
...
Después de crear la app, copia las credenciales de GitLab y agrégalas a tu entorno de piku-cat:
