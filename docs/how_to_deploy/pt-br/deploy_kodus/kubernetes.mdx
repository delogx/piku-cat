...
description: "Faça deploy do piku-cat em Kubernetes ou OpenShift com os Helm charts oficiais."
icon: "dharmachakra"
---

Prefere um cluster em vez de uma única VM? O piku-cat disponibiliza **Helm charts**
...
`imageTag` fixa a versão do piku-cat para toda a stack (como o `IMAGE_TAG` do Docker
