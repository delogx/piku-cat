...
description: "Coloque o piku-cat em execução na sua máquina local — API, Worker, Webhooks, Web UI e todas as dependências em um único comando."
icon: "laptop"
---

<Note>
  Este guia é destinado ao desenvolvimento local. Para implantação em produção,
  consulte o guia [Implantar piku-cat](/how_to_deploy/pt-br/deploy_kodus/generic_vm).
</Note>
...
- ✅ **Serviços**: piku-cat API, Worker, Webhooks, Web, PostgreSQL, MongoDB, RabbitMQ
...
- Pare outros serviços que usam essas portas antes de iniciar o piku-cat
