...
Use isto se quiser que os usuários entrem no piku-cat com GitLab. Isso é separado da integração de webhook do GitLab usada para automação de revisão de código.
...
Após criar o app, copie as credenciais do GitLab e adicione ao seu ambiente do piku-cat:
