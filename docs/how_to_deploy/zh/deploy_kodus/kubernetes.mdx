...
description: "使用官方 Helm charts 在 Kubernetes 或 OpenShift 上部署 piku-cat。"
icon: "dharmachakra"
---

相比单台虚拟机更倾向于使用集群？piku-cat 在
...
`imageTag` 为整个技术栈固定 piku-cat 版本（类似 Docker Compose 的 `IMAGE_TAG`）；生产环境
