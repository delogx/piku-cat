---
title: "本地快速开始"
description: "在本地计算机上运行 piku-cat — API、Worker、Webhooks、Web UI 和所有依赖项，一条命令全部启动。"
icon: "laptop"
---

<Note>
  本指南用于本地开发目的。对于生产部署，请参阅[部署 piku-cat](/how_to_deploy/zh/deploy_kodus/generic_vm) 指南。
</Note>
...
此综合健康检查验证：
- ✅ **服务**：piku-cat API、Worker、Webhooks、Web、PostgreSQL、MongoDB、RabbitMQ
