...
description: "创建为 piku-cat 用户启用「Sign in with GitHub」的 GitHub OAuth App —— 与用于代码审查的 GitHub App 相互独立。"
icon: github
---

如果您希望用户通过 GitHub 登录 piku-cat，请使用此方式。这与用于代码审查自动化和 Webhook 的 GitHub App 集成是分开的。
...
创建完成后，从 GitHub 复制凭据并写入 piku-cat 环境变量：
