...
<Steps>
  <Step title="Install">
    <Tabs>
      <Tab title="Skill Installer (Recommended)">
        Installs the CLI and deploys piku-cat skills to all detected AI agents (Claude Code, Cursor, Codex, Windsurf):
  ...
  <Step title="Authenticate">
    ...
    <Info>
      **Self-hosting piku-cat?** Point the CLI to your API before authenticating:
