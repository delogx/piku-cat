...
description: "Connect the Kodus CLI to your self-hosted piku-cat instance."
---

If you're running piku-cat on your own infrastructure, the CLI works the same way — you just need to point it to your API.

## Connect to Your Instance

<Steps>
  <Step title="Set the API URL">
    Tell the CLI where your piku-cat API lives. Pick one method:
  ...
  <Step title="Authenticate">
    <Tabs>
      <Tab title="Team Key (Recommended)">
        Generate a team key from your self-hosted piku-cat dashboard and configure it:
