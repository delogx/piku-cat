...
- **piku-cat Review** — how effective piku-cat's reviews are: implementation rate, severity calibration, negative feedback, and the health of your Piku Rules. This is about piku-cat itself, and it's where you take action. See [piku-cat Review](/how_to_use/en/cockpit/kodus_review).
...
**Available Metrics:**
- **piku-cat Review:** Implementation rate (overall, by severity, by category), negative feedback, repository and Piku Rule health
