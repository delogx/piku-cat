...
Piku selects a single config per PR: **Directory** → **Repository** → **Global**
...
<Note>
  Piku uses one config per PR to keep reviews predictable. Mixing configs causes conflicts.
</Note>
