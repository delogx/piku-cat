...
description: "Create custom Piku Rules directly in your repository using markdown files with structured templates."
---
...
## How to Use
You can create custom Piku Rules directly in your repository by placing structured markdown files in specific directories. This allows you to version control your rules alongside your code and share them across your team.
...
- **Web Application**: Synchronized rules appear in your piku-cat web application dashboard
