...
description: "Generate the Forgejo access token Piku needs to read your repositories and post review comments."
---
...
To enable Piku to perform automatic code reviews on Forgejo, you need to generate an **Access Token**. This token allows Piku to access your repositories, pull requests, webhooks, issues, etc., with the specific permissions listed below.
...
## Required Permissions for Piku

The token must include **all** of the following permissions for full functionality with Piku:
...
Paste the generated token into the **Piku integration settings screen** when enabling the Forgejo integration.
