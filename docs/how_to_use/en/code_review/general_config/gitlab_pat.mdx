...
description: "Generate the GitLab Personal Access Token Piku needs to read your repositories and post review comments, with the exact scopes required."
---

## Introduction to the PAT

To enable Piku to perform automatic Code Reviews, you need to generate a Personal Access Token (PAT) in GitLab. This token allows Piku to securely access your repositories and conduct code analysis in a controlled way.
