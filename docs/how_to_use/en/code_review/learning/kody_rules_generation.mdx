...
description: "Piku can automatically generate custom rules by analyzing your team's code review history. Let her learn from your past reviews to create personalized coding standards."
---

<Warning>
  **Requires at least 3 months of Piku review history on the repository.** This feature derives rules from Piku's past reviews on your PRs, so repositories that have just onboarded won't produce useful suggestions. If you recently started using Piku, come back after a few months of real reviews.
</Warning>

## Quick Overview

- **Auto-Generation**: Piku analyzes your review history to create new rules
...
2. Look for the **"Generate Piku Rules"** button
3. Click to start the automatic generation process

### 2. Analysis Process

When you click "Generate Piku Rules", Piku will:
...
After the initial setup, Piku maintains an ongoing learning cycle:

- **Weekly Updates**: Piku generates new rule suggestions every week
