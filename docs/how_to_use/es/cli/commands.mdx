...
description: "Referencia completa de todos los comandos, flags y opciones del CLI de piku-cat."
---
...
Gestiona la autenticación con la API de piku-cat.
...
Elimina el hook pre-push instalado por piku-cat.
...
Inspecciona y actualiza la configuración del repositorio almacenada en piku-cat. Se requiere autenticación con clave de equipo. Usa `.` para apuntar al repositorio actual.
...
```bash
kodus config repo add                                   # Agregar el repo actual a piku-cat
...
kodus config repo open                                  # Abrir el panel de piku-cat
...
| Subcomando                                         | Descripción                                                                 |
| -------------------------------------------------- | --------------------------------------------------------------------------- |
| `add [repository]`                                 | Agregar un repositorio a piku-cat (atajo: `kodus config -r [repository]`)      |
| `list`                                             | Listar repositorios configurados en piku-cat                                   |
...
| `open [repository]`                                | Abrir el panel de piku-cat para configuraciones avanzadas                      |
...
Crea, actualiza y visualiza Piku Rules — reglas estructuradas que piku-cat aplica durante la revisión.
...
| Subcomando | Descripción            |
| ---------- | ---------------------- |
| `create`   | Crear una nueva Piku Rule |
...
Muestra un estado consolidado de piku-cat: modo de autenticación, organización, repositorio, hook, skills incluidos y versión del CLI.
...
Actualiza el CLI de piku-cat a la última versión desde npm.
...
Abre la página de precios/actualización de piku-cat en tu navegador.
