...
description: "Conecta el CLI de piku-cat a tu instancia auto-alojada de piku-cat."
---

Si estás ejecutando piku-cat en tu propia infraestructura, el CLI funciona de la misma manera: solo necesitas apuntarlo a tu API.

## Conectar a Tu Instancia

<Steps>
  <Step title="Establecer la URL de la API">
    Indica al CLI dónde vive tu API de piku-cat. Elige un método:
  ...
  <Step title="Autenticarse">
    <Tabs>
      <Tab title="Clave de Equipo (Recomendado)">
        Genera una clave de equipo desde tu panel de piku-cat auto-alojado y configúrala:
