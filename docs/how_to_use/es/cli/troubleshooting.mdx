...
description: "Errores comunes del CLI de piku-cat, códigos de salida y cómo depurarlos."
---
...
- Solicitudes de funciones, preguntas de configuración: tu gestor de cuenta de piku-cat, o `support@kodus.io`.
