...
description: "Las Piku Rules son pautas personalizables que tu equipo configura para aplicar automáticamente calidad de código, consistencia, seguridad y mantenibilidad."
---
...
## Dos tipos en la interfaz de Piku Rules

Las Piku Rules están organizadas en dos categorías, gestionadas a través de una interfaz con pestañas en tu configuración:
...
<Tabs>
  ...
  <Tab title="Memorias">
    Instrucciones contextuales persistentes que se inyectan en todos los prompts y conversaciones. Las Memorias permiten a Piku aprender y retener cómo funciona tu código para que las futuras revisiones y sugerencias sean más relevantes.

    - Se inyectan como **contexto de alta prioridad** en revisiones de código, análisis entre archivos y conversaciones
    - Se crean vía **conversación con Piku** o **manualmente en la UI**
...
- Piku identifica las referencias a archivos automáticamente cuando guardas una regla
...
- El contenido de los archivos se inyecta en el contexto de la regla, permitiendo a Piku comparar, validar o aplicar patrones
...
- Navega a Reglas de Descubrimiento en tu panel de piku-cat.
...
- **Mejores sugerencias futuras**: Las Memorias ayudan a Piku a no repetir las mismas suposiciones equivocadas sobre tu repositorio
- **Deduplicación inteligente**: Cuando se crea una nueva memoria, Piku usa un mecanismo de resolución basado en LLM para determinar si crearla, omitirla (si es duplicada) o actualizar una memoria existente
...
La forma más natural de crear memorias es a través de la conversación con Piku en los comentarios del PR. Piku detecta tanto intenciones explícitas como implícitas de guardar convenciones:

**Explícita** — pedir directamente a Piku que recuerde:
...
**Implícita** — expresar una preferencia o convención que Piku captura:
...
<Info>
  Piku NO creará memorias para instrucciones transitorias (p. ej., "arregla esto ahora"), conversaciones de depuración, preguntas, declaraciones vagas o solicitudes explícitamente limitadas a una sola tarea o PR.
</Info>

Cuando se crea o actualiza una memoria, Piku responde con una confirmación y proporciona un **enlace directo** para ver la memoria en la UI.

#### Vía la UI

También puedes crear memorias manualmente:

1. Ve a **Configuración de Code Review** → **Repositorio** → **Piku Rules**
...
1. Ve a **Configuración de Code Review** → **Repositorio** → **Piku Rules** → pestaña **Memorias**
