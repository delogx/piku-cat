...
Con el backend vinculado, Piku comprueba el otro lado de ese contrato y comenta en el PR:
...
<Info>
- Solo se pueden vincular repositorios **ya conectados a la misma organización de piku-cat** (Piku reutiliza tu integración de Git existente — sin tokens adicionales).
- Hasta **3 repositorios vinculados** por repositorio.
- El acceso es de solo lectura. Piku nunca hace push, comenta ni modifica un repositorio vinculado.
...
Controla qué rama ("ref") del repositorio vinculado lee Piku. **La mayoría de los equipos lo deja vacío**: Piku entonces lee la rama con el mismo nombre que la de tu PR cuando existe (para que los cambios coordinados entre repositorios se vean antes del merge), y recurre a la rama por defecto en caso contrario.
