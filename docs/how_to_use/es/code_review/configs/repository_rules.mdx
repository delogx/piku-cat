...
description: "Crea Piku Rules personalizadas directamente en tu repositorio usando archivos markdown con plantillas estructuradas."
---
...
## Cómo Usar
Puedes crear Piku Rules personalizadas directamente en tu repositorio colocando archivos markdown estructurados en directorios específicos. Esto te permite versionar tus reglas junto con tu código y compartirlas con tu equipo.
...
- **Aplicación Web**: Las reglas sincronizadas aparecen en el panel de tu aplicación web de piku-cat
