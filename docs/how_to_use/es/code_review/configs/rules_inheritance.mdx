...
Por defecto, las Piku Rules se heredan hacia abajo en la jerarquía:
...
- <a href="/how_to_use/es/code_review/configs/kody_rules">Descripción General de Piku Rules</a>
