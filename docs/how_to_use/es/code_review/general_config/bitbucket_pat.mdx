...
description: "Genera el API Token de Bitbucket Cloud que Piku necesita para la revisión de código, con los permisos exactos a otorgar."
---

## Introducción

Para permitir que Piku realice revisiones de código automáticas en Bitbucket Cloud, necesitas generar un **Token API**. Este token permite a Piku acceder a tus repositorios, pull requests, webhooks, issues, pipelines, etc., con los permisos específicos listados a continuación.
...
## Alcances Requeridos para Piku

El token debe incluir **todos** los siguientes alcances para la funcionalidad completa con Piku:
...
- Una vez que el token esté generado con todos los alcances requeridos, pégalo en la **pantalla de configuración de integración/automatización de Piku** al habilitar la integración con Bitbucket.
- Asegúrate de que el token tenga `admin:repository:bitbucket` (o equivalente) si Piku necesita configurar webhooks o escuchar eventos de pull request.
