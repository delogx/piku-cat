...
3. Implanta as skills do piku-cat em todos os agentes detectados (Claude Code, Cursor, Codex, Windsurf).
...
Com o instalador de skills, a skill piku-cat do Claude Code sabe quando invocar cada um desses — sem necessidade de engenharia de prompt da sua parte.
