...
description: "Conecte o Kodus CLI à sua instância self-hosted do piku-cat."
---

Se você estiver executando o piku-cat na sua própria infraestrutura, o CLI funciona da mesma forma — você só precisa apontá-lo para a sua API.

## Conectar à Sua Instância

<Steps>
  <Step title="Definir a URL da API">
    Informe ao CLI onde sua API do piku-cat está. Escolha um método:
  ...
  <Step title="Autenticar">
    <Tabs>
      <Tab title="Chave de Equipe (Recomendado)">
        Gere uma chave de equipe no painel do piku-cat self-hosted e configure-a:
