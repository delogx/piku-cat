...
description: "Crie Piku Rules personalizadas diretamente no seu repositório usando arquivos markdown com templates estruturados."
---
...
## Como Usar
Você pode criar Piku Rules personalizadas diretamente no seu repositório colocando arquivos markdown estruturados em diretórios específicos. Isso permite versionar suas regras junto com o código e compartilhá-las com toda a equipe.
...
- **Aplicação Web**: As regras sincronizadas aparecem no painel do aplicativo web piku-cat
