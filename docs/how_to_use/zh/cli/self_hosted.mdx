---
title: "自托管配置"
description: "将 Kodus CLI 连接到您的自托管 piku-cat 实例。"
---

如果您在自己的基础设施上运行 piku-cat，CLI 的使用方式完全相同 — 只需将其指向您的 API。

## 连接到您的实例

<Steps>
  <Step title="设置 API URL">
    告诉 CLI 您的 piku-cat API 地址。选择一种方式：
