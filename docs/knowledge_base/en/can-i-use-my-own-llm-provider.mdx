...
description: "Bring your own API key and choose your preferred LLM provider for AI-powered code review with piku-cat."
---

Yes. piku-cat supports Bring Your Own Key (BYOK) on every plan, letting you use your preferred LLM provider. You pay the provider directly — piku-cat never marks up tokens and never sees your key in plain text.
...
3. Paste your API key and click **Test & save** — piku-cat validates the key with a cheap metadata call before persisting
...
If you self-host piku-cat, you can point BYOK at self-hosted or aggregator endpoints like:
