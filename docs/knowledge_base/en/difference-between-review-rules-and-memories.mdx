...
description: "Understand when to use Review Rules vs Memories in Piku for the best code review results."
---

In the Piku Rules UI, you configure two different things, and knowing when to use each one makes your code reviews more effective.

A useful rule of thumb:

- **Memories** teach Piku how your codebase works so future reviews and suggestions are more relevant.
- **Review Rules** tell Piku what to flag when a PR does not match your standards.
...
Memories are **persistent contextual instructions** injected across all interactions — code reviews, conversations, and AI suggestions. They represent the background knowledge Piku should carry about your codebase, conventions, and preferences.
...
- Improve future suggestions by grounding Piku in repo-specific context
- Created via conversation (`@kody remember: ...`) or manually in the UI
- Scoped to directory, repository, or organization level
- Piku auto-deduplicates and resolves conflicts between memories
...
For details, see [Piku Rules](/how_to_use/en/code_review/configs/kody_rules).
