...
Product specs and requirements often live in Google Docs. piku-cat can fetch the document content and compare it against your PR diff to verify that the implementation matches the spec.
...
4. Piku fetches the document, extracts the requirements, and compares them against the PR diff

## What you get

Piku produces a structured validation report:
