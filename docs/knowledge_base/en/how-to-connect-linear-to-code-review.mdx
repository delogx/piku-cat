...
description: "Link Linear to piku-cat so your AI code reviews automatically validate PRs against issue requirements."
---

Connecting Linear to piku-cat enables automatic **business logic validation** against Linear issues and richer context for code review suggestions.
...
4. Select which workspaces piku-cat can access

## What it enables

### Automatic business logic validation

When a PR is linked to a Linear issue, piku-cat automatically:
...
With Linear connected, Piku can reference task context in rules and conversations.
