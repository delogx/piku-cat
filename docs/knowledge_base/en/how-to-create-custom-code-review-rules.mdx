...
- **Auto-generation** — Piku suggests rules based on your review history

For the full reference, see [Piku Rules](/how_to_use/en/code_review/configs/kody_rules).
