...
## How it works with piku-cat

piku-cat lets you define **Piku Rules** — custom instructions that are checked automatically during every code review. There are two types:

- **Review Rules** run during code review and analyze file diffs or the entire PR against your standards
- **Memories** are persistent conventions that Piku applies across all interactions — code reviews, conversations, and suggestions
...
- **Auto-generating rules** — let Piku analyze 3 months of review history and suggest rules based on your team's patterns
...
4. Piku will enforce it on every future PR

For more details, see the [Piku Rules documentation](/how_to_use/en/code_review/configs/kody_rules).
