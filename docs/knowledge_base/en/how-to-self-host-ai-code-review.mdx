...
description: "Deploy piku-cat on your own infrastructure with full control over data, models, and configuration."
---

piku-cat is open-source and can be self-hosted on your own infrastructure. This gives you full control over your data, network access, and LLM provider.

## Deployment options

### Docker (recommended)

Deploy piku-cat using Docker Compose on any VM:

1. Clone the piku-cat repository
