...
description: "Install and configure piku-cat for GitHub repositories to get automated AI code review on every pull request."
---

Setting up piku-cat on GitHub takes a few minutes. Once connected, every pull request gets reviewed automatically.

## Steps

1. **Create an account** at [kodus.io](https://kodus.io) or [self-host piku-cat](/how_to_deploy/en/deploy_kodus/generic_vm)
2. **Connect GitHub** — install the piku-cat GitHub App when prompted during setup
3. **Select repositories** — choose which repositories piku-cat should review
4. **Open a PR** — piku-cat reviews it automatically and posts comments
