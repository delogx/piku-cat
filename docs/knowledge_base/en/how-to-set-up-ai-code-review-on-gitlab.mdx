...
description: "Install and configure piku-cat for GitLab projects to get automated AI code review on every merge request."
---

piku-cat integrates with GitLab via OAuth and webhooks. Once configured, merge requests are reviewed automatically.
...
4. **Select projects** — choose which GitLab projects piku-cat should review
5. **Open a merge request** — piku-cat reviews it automatically
