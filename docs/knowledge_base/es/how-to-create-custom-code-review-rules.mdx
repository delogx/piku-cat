...
- **Generación automática** — Piku sugiere reglas basadas en tu historial de revisiones

Para la referencia completa, consulta [Piku Rules](/how_to_use/es/code_review/configs/kody_rules).
