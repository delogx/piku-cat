...
## Cómo funciona con piku-cat

piku-cat te permite definir **Piku Rules** — instrucciones personalizadas que se verifican automáticamente durante cada revisión de código. Existen dos tipos:
...
- Las **Memories** son convenciones persistentes que Piku aplica en todas las interacciones — revisiones de código, conversaciones y sugerencias
...
- **Generación automática de reglas** — deja que Piku analice 3 meses de historial de revisiones y sugiera reglas basadas en los patrones de tu equipo
...
4. Piku lo aplicará en cada PR futuro

Para más detalles, consulta la [documentación de Piku Rules](/how_to_use/es/code_review/configs/kody_rules).
