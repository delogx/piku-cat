...
description: "Proporciona a Piku acceso a los documentos, manuales y guías de arquitectura de tu proyecto para revisiones de código más relevantes."
---

La revisión de código genérica detecta problemas genéricos. Para obtener feedback que sea realmente relevante para tu proyecto, Piku necesita entender tu contexto específico — decisiones de arquitectura, convenciones y reglas de negocio.

## Formas de proporcionar contexto

### Memorias

Enseña a Piku tus convenciones a través de la conversación:
...
Agrega instrucciones específicas del proyecto que Piku incluye en cada revisión:
...
3. Piku lo incluye en cada análisis de revisión de código

### Plugins MCP

Conecta herramientas externas para darle a Piku acceso a un contexto más enriquecido:
...
3. Conecta **Jira** para que Piku valide los PRs contra los requisitos de las tareas
