...
Cuando tienes múltiples repositorios, mantener la coherencia de los estándares de codificación es un desafío. piku-cat admite la herencia de reglas para que puedas definir reglas una vez y aplicarlas en todos lados.

## Reglas a nivel de organización

Crea reglas a nivel de organización y se aplican automáticamente a todos los repositorios:

1. Ve a **Configuración de Revisión de Código** → **Global** → **Piku Rules**
