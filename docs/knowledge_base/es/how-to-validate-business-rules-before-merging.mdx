...
piku-cat compara el diff de tu PR con los requisitos de la tarea e identifica:
...
Con `business_logic: true` en tus opciones de revisión (habilitado por defecto), piku-cat valida automáticamente las reglas de negocio durante cada revisión de PR cuando hay un plugin de gestión de tareas conectado.
...
- Si el alcance del PR no coincide con la tarea, Piku marca un desajuste de alcance en lugar de especular
