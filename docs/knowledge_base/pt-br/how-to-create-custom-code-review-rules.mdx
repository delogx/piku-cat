...
- **Geração automática** — o Piku sugere regras baseadas no seu histórico de revisões

Para a referência completa, consulte [Regras do Piku](/how_to_use/pt-br/code_review/configs/kody_rules).
