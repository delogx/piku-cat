...
description: "Dê ao Piku acesso aos documentos, manuais e guias de arquitetura do seu projeto para revisões de código mais relevantes."
---

Revisões de código genéricas identificam problemas genéricos. Para obter feedback realmente relevante para o seu projeto, o Piku precisa entender seu contexto específico — decisões arquiteturais, convenções e regras de negócio.

## Formas de fornecer contexto

### Memórias

Ensine o Piku sobre suas convenções por meio de conversas:
...
Adicione instruções específicas do projeto que o Piku inclui em cada revisão:
...
3. O Piku inclui isso em cada análise de revisão de código

### Plugins MCP

Conecte ferramentas externas para dar ao Piku acesso a um contexto mais rico:
...
3. Conecte o **Jira** para que o Piku valide PRs contra os requisitos das tarefas
