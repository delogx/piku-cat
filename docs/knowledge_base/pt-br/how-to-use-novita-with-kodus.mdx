...
description: "Aprenda como usar os modelos da Novita com o piku-cat"
icon: "server"
---
...
3. Clique em "Adicionar Nova Chave" e preencha com 'piku-cat' ou qualquer nome que desejar
...
<Tip>
  Para informações detalhadas sobre configuração de SSL, monitoramento e configurações avançadas, consulte nosso [guia completo de implantação](https://docs.kodus.io/how_to_deploy/pt-br/deploy_kodus/generic_vm).
</Tip>
