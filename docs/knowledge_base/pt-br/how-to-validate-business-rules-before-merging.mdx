...
O piku-cat compara o diff do seu PR com os requisitos da tarefa e identifica:
...
Com `business_logic: true` nas suas opções de revisão (habilitado por padrão), o piku-cat valida automaticamente as regras de negócio durante cada revisão de PR quando um plugin de gerenciamento de tarefas está conectado.
...
- Se o escopo do PR não corresponder à tarefa, o Piku sinaliza uma incompatibilidade de escopo em vez de especular
