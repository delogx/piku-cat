...
description: "了解如何在 piku-cat 中使用 Fireworks AI 的模型"
icon: "fire"
---
...
4. 为您的密钥提供一个描述性名称（例如，'piku-cat'或您偏好的任何名称）
5. 点击 **"Create"** 生成密钥
...
<Tip>
  有关 SSL 设置、监控和高级配置的详细信息，请参阅我们的[完整部署指南](https://docs.kodus.io/how_to_deploy/zh/deploy_kodus/generic_vm)。
</Tip>
