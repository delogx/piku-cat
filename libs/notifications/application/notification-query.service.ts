    ...
    async seedFakeNotifications(
        ...
        const fakes: Array<{
        ...
        }> = [
            {
                ...
                body: 'Piku finished generating rules from your most recent reviews. Check them out and approve the ones you want active.',
            ...
            },
            {
                ...
                body: 'A previous batch of generated Piku rules is still awaiting review.',
                read: true,
            },
        ];
